...
export default function Demo() {
  ...
  const handleShowExample = async () => {
    ...
    try {
      ...
      setLlmSuggestion(
        response.suggestion ||
          "Here's a step-by-step visualization of how binary search works by repeatedly dividing the search interval in half."
      );
      ...
      setLlmSuggestion(
        "I couldn't load the example at this time. Would you like to try a different explanation instead?"
      );
    }
  };
  ...
  const handleContinue = () => {
    setLlmSuggestion(
      'Moving on to the next concept: Time Complexity Analysis. Would you like me to explain this concept with examples?'
    );
            ...
            <div className="p-6 border-b md:border-b-0 md:border-r border-slate-200">
              ...
              <div className="bg-slate-800 rounded-lg overflow-hidden mb-4 aspect-video flex items-center justify-center relative">
                {webcamEnabled ? (
                  ...
                  <div className="text-center p-8">
                    ...
                    <p className="text-slate-400 text-sm">Enable camera to track attention</p>
                  </div>
                )}
                <Button
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-slate-700">
                    {Math.round(attentionData.score * 100)}%
                  </span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-slate-700">
                    {getFocusStabilityLabel(attentionData.focusStability)}
                  </span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between mb-1">
                  ...
                  <span className="text-sm font-medium text-slate-700">
                    {getCognitiveLoadLabel(attentionData.cognitiveLoad)}
                  </span>
                </div>
              ...
              <div className="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-primary-700">{llmSuggestion}</p>
