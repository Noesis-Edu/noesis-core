  ...
  const architectureLayers = [
    {
      ...
      description:
        'Capture and normalize attention signals from webcams, eye tracking, mouse movement, and other input sources.',
    ...
    },
    {
      ...
      description:
        'Processes raw inputs into normalized attention scores. Detects focus, cognitive load, and engagement levels.',
    ...
    },
    {
      ...
      title: 'Orchestration',
      description:
        'LLM-powered adaptive learning logic that dynamically adjusts content, pacing, and feedback based on learner state.',
      capabilities: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600">
            Noesis SDK provides a flexible, adaptable learning intelligence layer that can be
            integrated into any application or platform.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {architectureLayers.map((layer, index) => (
            <div
              key={index}
              className="relative bg-white rounded-lg border border-slate-200 shadow-sm p-6 flex flex-col"
            >
              ...
              <p className="text-slate-600 text-sm flex-1">{layer.description}</p>
              <div className="mt-4 pt-4 border-t border-slate-100">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  ...
                  {layer.capabilities &&
                    layer.capabilities.map((item, idx) => (
                      <Badge
                        key={idx}
                        variant="secondary"
                        className={
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center">
            <div className="flex-1">
              ...
              <p className="mt-2 text-slate-600">
                Noesis follows an open-core model, with core SDK components under MIT license, while
                the LLM orchestration layer is available as a SaaS service.
              </p>
            </div>
