  ...
  return (
    <>
      ...
      <p className="text-slate-700 mb-6">
        Welcome to the Noesis SDK documentation. This guide will help you get up and running with
        the Noesis Adaptive Learning SDK in your application.
      </p>
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-700 mb-4">Import and initialize the SDK in your application:</p>
