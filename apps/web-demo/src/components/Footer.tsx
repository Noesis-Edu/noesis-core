      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-8 md:mb-0">
            ...
            <p className="mt-4 text-slate-400 max-w-md">
              The universal infrastructure layer for adaptive, attention-aware learning experiences
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <Link href="/#getstarted" className="text-slate-400 hover:text-white">
                    Get Started
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <a
                    href="https://github.com/noesis-sdk/community"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-slate-400 hover:text-white"
                  >
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <a
                    href="mailto:contact@noesis-sdk.dev"
                    className="text-slate-400 hover:text-white"
                  >
                    Contact
                  </a>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            ...
            <Link href="/security" className="text-slate-400 hover:text-white">
              Security
            </Link>
          </div>
        </div>
